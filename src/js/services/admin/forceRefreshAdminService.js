...
export const getCronStatus = async () => apiClient.get(adminEndpoints.cronStatus);

export const getWebSocketHealth = async () => apiClient.get(adminEndpoints.webSocketHealth);
