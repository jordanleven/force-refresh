<?php
/**
 * Our mock for the global `get_posts` function.
 *
...
/**
 * Class for the `get_posts` Mock
 */
final class Mock_Get_Posts extends Mock_Function implements Mock_Function_Interface {
     ...
     * @var string
     */
    const MOCK_FUNCTION_NAME = 'get_posts';
