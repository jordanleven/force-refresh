...
function force_refresh_specific_page_refresh_html(){
    ...
    $show_force_refresh_in_wp_admin_bar = get_option(WP_FORCE_REFRESH_OPTION_SHOW_IN_WP_ADMIN_BAR);
    ...
    add_style("force-refresh-meta-box-admin-css", "force-refresh-meta-box-admin.built.min.css");

    // Include the admin JS
    add_script("force-refresh-meta-box-admin-js", "force-refresh-meta-box-admin.built.min.js", true);
    ...
    $handlebars_replacements = array(
        ...
        "options" => array(
            "preset_value_force_refresh_in_admin_bar_show" => $show_force_refresh_in_wp_admin_bar == true ? "selected" : null,
            "preset_value_force_refresh_in_admin_bar_hide" => $show_force_refresh_in_wp_admin_bar == false ? "selected" : null
        )
    );
...
/**
 * Hook used to enqueue CSS and JS, as well as add the optiona Force Refresh button to the WordPress Admin Bar.
 */
...
function show_force_refresh_in_wp_admin_bar(){
    ...
    $args = array(
        'id'     => 'force-refresh',
        'title'  => "<i class=\"fa fa-refresh\" aria-hidden=\"true\"></i> <span>Force Refresh</span>",
        'href'   => null,
    );
