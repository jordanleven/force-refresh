<?php
/**
 * Our mock for the global `get_transient` function.
 *
...
/**
 * Class for the `get_transient` Mock
 */
final class Mock_Get_Transient extends Mock_Function implements Mock_Function_Interface {
     ...
     * @var string
     */
    const MOCK_FUNCTION_NAME = 'get_transient';
