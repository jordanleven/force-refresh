<?php
/**
 * Our mock for the global `delete_option` function.
 *
...
/**
 * Class for the `delete_option` Mock.
 */
final class Mock_Delete_Option extends Mock_Function implements Mock_Function_Interface {
     ...
     * @var string
     */
    const MOCK_FUNCTION_NAME = 'delete_option';
