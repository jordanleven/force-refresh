<?php
/**
 * Our mock for the global `get_rest_url` function.
 *
...
/**
 * Class for the `get_rest_url` Mock
 */
final class Mock_Get_Rest_Url extends Mock_Function implements Mock_Function_Interface {
     ...
     * @var string
     */
    const MOCK_FUNCTION_NAME = 'get_rest_url';
