<?php
/**
 * Our mock for the global `update_option` function.
 *
...
/**
 * Class for the `update_option` Mock.
 */
final class Mock_Update_Option extends Mock_Function implements Mock_Function_Interface {
     ...
     * @var string
     */
    const MOCK_FUNCTION_NAME = 'update_option';
