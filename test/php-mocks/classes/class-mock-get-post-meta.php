<?php
/**
 * Our mock for the global `get_post_meta` function.
 *
...
/**
 * Class for the `get_post_meta` Mock
 */
final class Mock_Get_Post_Meta extends Mock_Function implements Mock_Function_Interface {
     ...
     * @var string
     */
    const MOCK_FUNCTION_NAME = 'get_post_meta';
